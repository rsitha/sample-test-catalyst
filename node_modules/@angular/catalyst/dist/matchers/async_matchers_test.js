import { asyncMatchers, beforeEach, describe, expect, it, TEST_ONLY } from '../index.js';
import { BehaviorSubject, NEVER, Observable, of, ReplaySubject, throwError } from 'rxjs';
    ...
    describe('toEmit', () => {
        ...
        beforeEach(() => {
            toEmitCompare = TEST_ONLY
                .asyncMatchersRaw['toEmit'](jasmine.matchersUtil, [NATIVE_EQ_TESTER])
                .compare;
        });
    ...
    describe('toResolveWith', () => {
        ...
        beforeEach(() => {
            toResolveWithCompare = TEST_ONLY
                .asyncMatchersRaw['toResolveWith'](jasmine.matchersUtil, [NATIVE_EQ_TESTER])
                .compare;
        });
    ...
    describe('toRejectWith', () => {
        ...
        beforeEach(() => {
            toRejectWithCompare = TEST_ONLY
                .asyncMatchersRaw['toRejectWith'](jasmine.matchersUtil, [NATIVE_EQ_TESTER])
                .compare;
        });
    ...
    describe('toRejectWithError', () => {
        ...
        beforeEach(() => {
            toRejectWithErrorCompare =
                TEST_ONLY
                    .asyncMatchersRaw['toRejectWithError'](jasmine.matchersUtil, [NATIVE_EQ_TESTER])
                    .compare;
        });
        it('passes when rejection is Error with expected error message RegExp', () => {
            ...
            expect(result.pass).toBe(true);
            expect(result.message)
                .toMatch(new RegExp('^Expected not to reject with an Error that has the message ' +
        ...
        it('failes when rejection is Error with unexpected error message RegExp', () => {
            ...
            expect(result.pass).toBe(false);
            expect(result.message)
                .toMatch(new RegExp('^Expected to reject with an Error that has the message ' +
                'that matches the RegExp:.*'));
        });
        it('passes when rejection is Error with expected error message string', () => {
            ...
            expect(result.pass).toBe(true);
            expect(result.message)
                .toMatch(new RegExp('^Expected not to reject with an Error ' +
        ...
        it('fails when rejection is Error with unexpected error message string', () => {
            ...
            expect(result.pass).toBe(false);
            expect(result.message)
                .toMatch(/^Expected to reject with an Error that has the message:*/);
        });
        ...
        it('fails when rejection is not an Error', () => {
            ...
            expect(result.pass).toBe(false);
            expect(result.message)
                .toMatch(/^Expected promise to reject with an Error but rejected with:.*/);
        });
        it('fails when promise resolves', () => {
            const p = Promise.resolve('it resolved to this string');
            const result = toRejectWithErrorCompare(p);
